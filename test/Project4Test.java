...
/** Test file for Project 4, sorting (cs545).
...
public class Project4Test {
    ...
    public void testBucketSort() {
        ...
        for (int i = 0; i < NUM_ITERS; i++) {
            ...
            algo.bucketSort(arr, lowindex, highindex, false);
        ...
        for (int i = 0; i < NUM_ITERS; i++) {
            ...
            int highindex = arr2.length / 2 + r.nextInt(arr2.length / 2);
              switch (methodName) {
                ...
                case "heap":
                    listSorter.heapSort(arr1, 0, arr1.length - 1);
                    listSorter.heapSort(arr2, lowindex, highindex);
                    break;
            }
